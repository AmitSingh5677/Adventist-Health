 ...
 value={startDate} onChange={(e)=>setStartDate(e.target.value)}  placeholder='start date'/>
      ...
      <Table className="table table-hover borderless responsive striped">
                          <thead className='table-header-analytics' style={{backgroundColor:"#E3E3E3"}}>
                            <tr >
                              <th className="table_theader py-2" style={{backgroundColor:"#E3E3E3",color:"#6E6E6E"}}>USER/PATIENT</th>
                              <th className="table_theader" style={{backgroundColor:"#E3E3E3",color:"#6E6E6E"}}>
                                EQUIPMENT DETAILS
                              </th>
                              <th className="table_theader" style={{backgroundColor:"#E3E3E3",color:"#6E6E6E"}}>ORDER DETAILS</th>
                              <th className="table_theader" style={{backgroundColor:"#E3E3E3",color:"#6E6E6E"}}>STATUS</th>
                            </tr>
                          </thead>
